...
public class LogicTest {
    ...
    public void setup() throws Exception {
        saveFile = new StorageStub(
                saveFolder.newFile("testSaveFile.txt").getPath());
    ...
    private void assertCommandBehavior(String inputCommand,
        ...
        assertCommandBehavior(inputCommand, expectedMessage,
     ...
     */
    private void assertCommandBehavior(String inputCommand,
            String expectedMessage, AddressBook expectedAddressBook,
        ...
        assertEquals(r.getRelevantPersons().isPresent(),
    ...
    public void execute_addDuplicate_notAllowed() throws Exception {
        ...
        // execute command and verify result
        assertCommandBehavior(helper.generateAddCommand(toBeAdded),
                AddCommand.MESSAGE_DUPLICATE_PERSON, expectedAB, false,
    ...
    public void execute_list_showsAllPersons() throws Exception {
        ...
        List<? extends ReadOnlyPerson> expectedList = expectedAB.getAllPersons()
                .immutableListView();
     ...
     */
    private void assertInvalidIndexBehaviorForCommand(String commandWord)
            throws Exception {
    ...
    public void execute_view_onlyShowsNonPrivate() throws Exception {
        ...
        assertCommandBehavior("view 1",
                String.format(ViewCommand.MESSAGE_VIEW_PERSON_DETAILS,
                        p1.getAsTextHidePrivate()),
                expectedAB, false, lastShownList);
    ...
    public void execute_tryToViewMissingPerson_errorMessage() throws Exception {
        ...
        assertCommandBehavior("view 1",
                Messages.MESSAGE_PERSON_NOT_IN_ADDRESSBOOK, expectedAB, false,
                lastShownList);
    }
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        ...
        List<Person> fourPersons = helper.generatePersonList(p1, pTarget1, p2,
                pTarget2);
    ...
    public void execute_find_matchesIfAnyKeywordPresent() throws Exception {
        TestDataHelper helper = new TestDataHelper();
        Person pTarget1 = helper.generatePersonWithName("bla bla KEY bla");
        Person pTarget2 = helper
                .generatePersonWithName("bla rAnDoM bla bceofeia");
        Person p1 = helper.generatePersonWithName("key key");
        Person p2 = helper.generatePersonWithName("KEy sduauo");
    ...
    class TestDataHelper {
         ...
         *            will be private
         */
        Person generatePerson(int seed, boolean isAllFieldsPrivate)
                throws Exception {
            return new Person(new Name("Person " + seed),
        ...
        String generateAddCommand(Person p) {
            ...
            cmd.add((p.getAddress().isPrivate() ? "pa/" : "a/")
                    + p.getAddress());
         ...
         */
        AddressBook generateAddressBook(Boolean... isPrivateStatuses)
                throws Exception {
         ...
         *            persons should be set to private.
         */
        void addToAddressBook(AddressBook addressBook,
                Boolean... isPrivateStatuses) throws Exception {
            addToAddressBook(addressBook,
                    generatePersonList(isPrivateStatuses));
        }
         ...
         */
        void addToAddressBook(AddressBook addressBook,
                List<Person> personsToAdd) throws Exception {
         ...
         *            persons should be set to private.
         */
        List<Person> generatePersonList(Boolean... isPrivateStatuses)
                throws Exception {
        ...
        Person generatePersonWithName(String name) throws Exception {
            return new Person(new Name(name), new Phone("1", false),
