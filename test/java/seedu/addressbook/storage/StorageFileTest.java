...
public class StorageFileTest {
    ...
    public void load_invalidFormat_exceptionThrown() throws Exception {
        // The file contains valid xml data, but does not match the AddressBook
        // class
    ...
    public void load_validFormat() throws Exception {
        ...
        // TODO: overwrite equals method in AddressBook class and replace with
        // equals method below
    ...
    private AddressBook getTestAddressBook() throws Exception {
        ...
        ab.addPerson(new Person(new Name("John Doe"), new Phone("98765432", false), new Email("johnd@gmail.com", false),
                new Address("John street, block 123, #01-01", false), new UniqueTagList(Collections.emptySet())));
        ab.addPerson(new Person(new Name("Betsy Crowe"), new Phone("1234567", true),
                new Email("betsycrowe@gmail.com", false), new Address("Newgate Prison", true),
