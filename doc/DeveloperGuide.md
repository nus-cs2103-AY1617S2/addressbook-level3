...
`* * *` | user | write notes for each contact | remember where I met them
`* * *` | user | add social media handles for each contact | find them online
...
6. Should start-up within 2 seconds
