...
`* * *` | user | save the address book data automatically after exiting | retrieve address book when I want to open the addressbook.
...
5. Should process commands in less than 2 seconds.
