...
`* *` | user | search person by address | if user wants to know who lives around the same area
`* *` | user | undo previous command | user may input the wrong command and hence needs to undo
...
5. Should come with user test cases
