...
`* * *` | user | rename a specific tag name to another name | I don't have to go to each person and change the tag name 1 by 1
`* * *` | user | clear the address book | start a new address book
