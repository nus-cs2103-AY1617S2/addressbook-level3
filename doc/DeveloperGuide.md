...
`* *` | user | backup my contacts | recover my contacts if I accidentally delete them
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with many persons in the address book | sort persons by their first char | locate a person easily
