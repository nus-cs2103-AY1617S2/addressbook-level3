...
4. AddressBook prompts user for confirmation to rename tag
5. User confirms renaming of the tag
6. AddressBook updates the tag name <br>
Use case ends
...
5. Should work have quick response time
6. Should work with English commands
