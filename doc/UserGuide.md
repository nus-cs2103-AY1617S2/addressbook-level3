...
> The search is case insensitive, the order of the keywords does not matter. Name, Phone, Email, Address and tags are searched,
...
* `find johnd`<br>
  Returns Any person having email containing `johnd`
* `find 1234567`<br>
  Returns Any person having phone containing `1234567`
* `find friend`<br>
  Returns Any person having tag `friend`
