...
public class StorageStub extends StorageFile {
	...
	public StorageStub() throws InvalidStorageFilePathException {
		super();
		// if do not initialize jaxbContext as the following, 
		// the constructor of the super class will not initialize jaxbContext
        try {
...
// the version that can pass the original test (without save unchanged)
