...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_FIELD = "The field provided is invalid";
    ...
    public static final String MESSAGE_PERSONS_SORTED_OVERVIEW = "Number of persons sorted: %1$d";
