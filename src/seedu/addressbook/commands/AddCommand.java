...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ":\n" + "Adds a person to the address book. "
            ...
            + "Parameters: NAME [p]p/PHONE [p]e/EMAIL [p]a/ADDRESS [p]r/RELIGION [p]b/RACE [p]n/NATIONALITY [t/TAG]...\n\t"
            + "Example: " + COMMAND_WORD
            + " John Doe p/98765432 e/johnd@gmail.com a/311, Clementi Ave 2, #02-25 r/Buddhism b/Malay n/Singaporean t/friends t/owesMoney";
